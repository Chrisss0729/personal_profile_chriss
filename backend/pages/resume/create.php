            ...
            <div class="card-body">
                <div class="table-responsive">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h4 class="fw-bold text-primary">📑 Tambah Table Resume</h4>
                        <a href="./index.php" class="btn btn-primary">❮❮ Kembali</a>
                    </div>
                    <table class="table table-modern align-middle">
                        <form action="../../action/resume/store.php" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="descriptionInput" class="form-control"
                                    rows="5" placeholder="Masukkan Deskripsi" required></textarea>
                            </div>
