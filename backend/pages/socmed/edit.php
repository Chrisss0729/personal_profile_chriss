      ...
      <div class="card-body">
        <div class="table-responsive">
          <div class="d-flex align-items-center justify-content-between mb-4">
            <h4 class="fw-bold text-primary">📱 Tabel Sosmed</h4>
          ...
          <table class="table table-modern align-middle">
            ...
            <form action="../../action/socmed/update.php?id=<?= $socmed->id ?>" method="POST" enctype="multipart/form-data">
              <div class="mb-3">
                ...
                <input type="text" name="icon" id="iconInput" class="form-control" placeholder="Masukkan Icon, Contoh: fab fa-instagram" required value="<?= $socmed->icon ?>">
              </div>
              <div class="mb-3">
