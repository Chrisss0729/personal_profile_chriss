            ...
            <div class="card-body">
                <div class="table-responsive">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h4 class="fw-bold text-primary">🧰 Tambah Tabel Service</h4>
                        ...
                        <form action="../../action/service/store.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="job" class="form-control" id="jobInput"
                                    placeholder="Masukkan Pekerjaan" required maxlength="255">
                            </div>

                            <!-- Icon Field -->
                            <div class="mb-3">
                                <label for="iconInput" class="form-label">Icon</label>
                                <input type="text" name="icon" id="iconInput" class="form-control" placeholder="Masukkan Icon, Contoh: fab fa-instagram" required>
                            </div>
