...
<section class="blog-listing">
    <div class="listing-header">
        <h2 class="section-title">Daftar Blog</h2>
        <a href="../../index.php#blog-section" class="back-btn">
            ...
            ?>
                <div class="blog-card">
                    <div class="blog-img-container">
                        <a href="detail_blog.php?id=<?= $row['id'] ?>">
                            <img src="<?= $imagePath ?>"
                    ...
                    <div class="blog-content">
                        <a href="detail_blog.php?id=<?= $row['id'] ?>" class="blog-title">
                        ...
                        <a href="detail_blog.php?id=<?= $row['id'] ?>" class="read-more">
                            Baca Selengkapnya
                        </a>
                    </div>
                </div>
